<template>
    ...
    <div class="settingspage">
        <div class="back">
            <div class="icon-button" @click="this.$router.push('/profile')">
        ...
        <div class="settings">
            ...
            <div class="parameters">
                <div class="row">
                    <p class="param">Виброотклик</p>
                    <SwitchBox :type="1"/>
                </div>
                <div class="row">
                    <p class="param">Уведомления</p>
                    <SwitchBox :type="2"/>
                </div>
                <div class="row">
                    <p class="param">Анимации</p>
                    <SwitchBox :type="3"/>
                </div>
            </div>
            ...
            <div class="message">
                <p class="mes">
                    Наш проект находится на стадии альфа версии. Если ты нашел какую-то проблему или баг, то, пожалуйста, сообщи нам по кнопке ниже
                </p>
